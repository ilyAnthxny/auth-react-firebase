  ...
  return (
    ...
    <div className='w-full max-w-xs m-auto'>
      ...
      <form onSubmit={handleSubmit} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 ">
        ...
        <div className='mb-4'>
          <label htmlFor="email" className='block text-gray-700 text-sm ont-bold mb-2'>Email</label>
            <input 
              type="email" 
              name='email' 
        ...
        <div className='flex items-center justify-between'>
          ...
          <button className='bg-blue-500 hoverbg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline'>Login</button>
